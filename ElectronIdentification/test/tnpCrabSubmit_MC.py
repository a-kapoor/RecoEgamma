...
if __name__ == '__main__':
    ...
    # config.General.requestName = 'ZprimeToTT_M3000_W30_TuneCP5_14TeV-madgraphMLM-pythia8_June2021newflag'
    # submit(config)
    ...
    # config.General.requestName = 'ZprimeToTT_M4000_W40_TuneCP5_14TeV-madgraphMLM-pythia8_June2021newflag'
    # submit(config)
    ...
    # config.General.requestName = 'QCD_Pt-120to170_EMEnriched_TuneCP5_14TeV_pythia8_June2021newflag'
    # submit(config)
    ...
    # config.General.requestName = 'QCD_Pt-170to300_EMEnriched_TuneCP5_14TeV_pythia8_June2021newflag'
    # submit(config)
    ...
    # config.General.requestName = 'QCD_Pt-300toInf_EMEnriched_TuneCP5_14TeV_pythia8_June2021newflag'
    # submit(config)
    ...
    # config.General.requestName = 'QCD_Pt-30to50_EMEnriched_TuneCP5_14TeV_pythia8_June2021newflag'
    # submit(config)
    ...
    # config.General.requestName = 'QCD_Pt-50to80_EMEnriched_TuneCP5_14TeV_pythia8_June2021newflag'
    # submit(config)
    ...
    # config.General.requestName = 'QCD_Pt-80to120_EMEnriched_TuneCP5_14TeV_pythia8_June2021newflag'
    # submit(config)
    ...
    # config.General.requestName = 'DYJets_incl_MLL-50_TuneCP5_14TeV-madgraphMLM-pythia8_June2021newflag'
    # submit(config)
    ...
    # config.General.requestName = 'DYToEE_M-50_NNPDF31_TuneCP5_14TeV-powheg-pythia8_June2021newflag'
    # submit(config)
    ...
    # config.General.requestName = 'TauGun_Pt-15to500_14TeV-pythia8_June2021newflag'
    # submit(config)
    ...
    # config.General.requestName = 'GJet_Pt-20to40_DoubleEMEnriched_MGG-80toInf_TuneCP5_14TeV_Pythia8_June2021newflag'
    # submit(config)
    ...
    # config.General.requestName = 'GJet_Pt-20toInf_DoubleEMEnriched_MGG-40to80_TuneCP5_14TeV_Pythia8_June2021newflag'
    # submit(config)
    ...
    # config.General.requestName = 'GJet_Pt-40toInf_DoubleEMEnriched_MGG-80toInf_TuneCP5_14TeV_Pythia8_June2021newflag'
    # submit(config)
    ...
    # config.General.requestName = 'QCD_Pt-15to7000_TuneCP5_Flat_14TeV_pythia8_June2021newflag'
    # submit(config)
    ...
    config.General.requestName ="QCD_Pt_15to20_bcToE_TuneCP5_13TeV_pythia8_June2021newflag"
    submit(config)
    ...
    config.General.requestName ="QCD_Pt_170to250_bcToE_TuneCP5_13TeV_pythia8_June2021newflag"
    submit(config)
    ...
    config.General.requestName ="QCD_Pt_20to30_bcToE_TuneCP5_13TeV_pythia8_June2021newflag"
    submit(config)
    ...
    config.General.requestName = "QCD_Pt_250toInf_bcToE_TuneCP5_13TeV_pythia8_June2021newflag"
    submit(config)
    ...
    config.General.requestName = "QCD_Pt_30to80_bcToE_TuneCP5_13TeV_pythia8_June2021newflag"
    submit(config)
    ...
    config.General.requestName = "QCD_Pt_80to170_bcToE_TuneCP5_13TeV_pythia8_June2021newflag"
    submit(config)
